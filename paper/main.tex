...
\author{%
  ...
  paper source at \url{https://github.com/goable-io/inverse-suitability-paper}
...
\input{sections/04-identification}
\input{sections/05-synthetic-recovery}
\input{sections/06-atlas}
