...
the \texttt{inverse-\allowbreak suitability latent-demo} command together with the table- and
figure-generation scripts---are released at
\url{https://github.com/goable-io/inverse-suitability} under the MIT licence
